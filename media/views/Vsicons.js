var app = (function () {
    ...
    const file$3 = "webviews\\components\\Model.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$3, 23, 99, 508);
    			...
    			add_location(path1, file$3, 23, 136, 545);
    			attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg0, "viewBox", "0 0 24 24");
    			attr_dev(svg0, "width", "24");
    			attr_dev(svg0, "height", "24");
    			add_location(svg0, file$3, 23, 16, 425);
    			attr_dev(span0, "class", "svelte-uhr7xa");
    			add_location(span0, file$3, 24, 16, 878);
    			attr_dev(span1, "class", "modal_title svelte-uhr7xa");
    			add_location(span1, file$3, 22, 12, 381);
    			attr_dev(path2, "fill", "none");
    			attr_dev(path2, "d", "M0 0h24v24H0z");
    			add_location(path2, file$3, 27, 99, 1083);
    ...
    const file$2 = "node_modules\\svelte-color-picker\\src\\HsvPicker.svelte";
    ...
    class HsvPicker extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { startColor: 10 });
    ...
    /* node_modules\svelte-clipboard\src\Clipboard.svelte generated by Svelte v3.38.2 */
    const file$1 = "node_modules\\svelte-clipboard\\src\\Clipboard.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea_1, file$1, 34, 0, 537);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (41:16) {#each category.iconsvg as icon}
    function create_each_block_1(ctx) {
    	...
    	let div0;
    	let html_tag;
    	let raw_value = /*icon*/ ctx[13].content + "";
    	let t1;
    	let p;
    	let t2_value = shortentext(/*icon*/ ctx[13].name) + "";
    	let t2;
    	let mounted;
    	let dispose;

    	function click_handler() {
    		return /*click_handler*/ ctx[3](/*icon*/ ctx[13]);
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*iconsarray*/ 2 && raw_value !== (raw_value = /*icon*/ ctx[13].content + "")) html_tag.p(raw_value);
    			if (dirty & /*iconsarray*/ 2 && t2_value !== (t2_value = shortentext(/*icon*/ ctx[13].name) + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:16) {#each category.iconsvg as icon}",
    		ctx
    	});
    ...
    // (36:8) {#each iconsarray as category}
    function create_each_block(ctx) {
    	...
    	let div1;
    	let t2;
    	let each_value_1 = /*category*/ ctx[10].iconsvg;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 37, 16, 955);
    			attr_dev(div0, "class", "iconcategory_title");
    			add_location(div0, file, 36, 12, 905);
    			attr_dev(div1, "class", "fileiconcontainer svelte-mpbjc9");
    			add_location(div1, file, 39, 12, 1034);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*iconsarray*/ 2 && t0_value !== (t0_value = /*category*/ ctx[10].name + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*modal, currentsvg, iconsarray, shortentext*/ 7) {
    				each_value_1 = /*category*/ ctx[10].iconsvg;
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:8) {#each iconsarray as category}",
    		ctx
    	});
    ...
    // (103:24) <Clipboard                              text="Your Text Need to Copy"                              let:copy                              on:copy={() => {                                  console.log("Has Copied");                              }}                          >
    function create_default_slot_1(ctx) {
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[5](/*copy*/ ctx[9]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			span = element("span");
    			span.textContent = "Copy Svg";
    			attr_dev(path0, "fill", "none");
    			attr_dev(path0, "d", "M0 0h24v24H0z");
    			add_location(path0, file, 131, 37, 4973);
    			attr_dev(path1, "d", "M6 4v4h12V4h2.007c.548 0 .993.445.993.993v16.014a.994.994 0 0 1-.993.993H3.993A.994.994 0 0 1 3 21.007V4.993C3 4.445 3.445 4 3.993 4H6zm2-2h8v4H8V2z");
    			attr_dev(path1, "fill", "rgba(255,255,255,1)");
    			add_location(path1, file, 131, 75, 5011);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			attr_dev(svg, "width", "24");
    			attr_dev(svg, "height", "24");
    			attr_dev(svg, "class", "svelte-mpbjc9");
    			add_location(svg, file, 126, 32, 4704);
    			attr_dev(span, "class", "svelte-mpbjc9");
    			add_location(span, file, 136, 32, 5392);
    			attr_dev(button, "title", "copy svg");
    			attr_dev(button, "class", "button svelte-mpbjc9");
    			add_location(button, file, 110, 28, 4028);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(103:24) <Clipboard                              text=\\\"Your Text Need to Copy\\\"                              let:copy                              on:copy={() => {                                  console.log(\\\"Has Copied\\\");                              }}                          >",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	let t5;
    	let h2;
    	let t6_value = /*currentsvg*/ ctx[2].name + "";
    	let t6;
    	let t7;
    	let div3;
    	let hsvpicker;
    	...
    	clipboard0 = new Clipboard({
    			props: { text: /*currentsvg*/ ctx[2].content },
    			$$inline: true
    		});

    	clipboard0.$on("copy", /*copy_handler*/ ctx[4]);
    	...
    	clipboard1.$on("copy", /*copy_handler_1*/ ctx[6]);
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			span1 = element("span");
    			span1.textContent = "Insert";
    			html_tag = new HtmlTag(null);
    			attr_dev(div0, "class", "img-avatar svelte-mpbjc9");
    			add_location(div0, file, 62, 12, 1888);
    			attr_dev(div1, "class", "portada svelte-mpbjc9");
    			add_location(div1, file, 78, 16, 2535);
    			attr_dev(path0, "fill", "none");
    			attr_dev(path0, "d", "M0 0h24v24H0z");
    			add_location(path0, file, 86, 29, 2897);
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(clipboard1, div4, null);
    			append_dev(div4, t9);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*currentsvg*/ 4) clipboard0_changes.text = /*currentsvg*/ ctx[2].content;
    			clipboard0.$set(clipboard0_changes);
    			if ((!current || dirty & /*currentsvg*/ 4) && raw_value !== (raw_value = /*currentsvg*/ ctx[2].content + "")) html_tag.p(raw_value);
    			if ((!current || dirty & /*currentsvg*/ 4) && t6_value !== (t6_value = /*currentsvg*/ ctx[2].name + "")) set_data_dev(t6, t6_value);
    			const clipboard1_changes = {};

    			if (dirty & /*$$scope, currentsvg*/ 65540) {
    				clipboard1_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(61:4) <Model bind:this={modal}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 34, 4, 828);
    			add_location(div1, file, 33, 0, 817);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
